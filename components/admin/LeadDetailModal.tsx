          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 mt-1 flex-wrap">
              <select
                ...
                className="text-xs font-semibold px-2 py-1 rounded-full bg-[#485A47] text-white border-none outline-none cursor-pointer"
              >
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="p-6 grid grid-cols-2 gap-4 border-b border-gray-100">
            {[
              ...
              <div key={field}>
                ...
                <input
                  ...
                  placeholder="—"
                  className="w-full text-sm text-gray-700 bg-gray-50 rounded-lg px-3 py-1.5 border border-transparent focus:border-[#485A47] focus:bg-white outline-none transition-colors"
                />
              </div>
            ))}
            ...
            <div>
              ...
              <select
                ...
                className="w-full text-sm text-gray-700 bg-gray-50 rounded-lg px-3 py-1.5 border border-transparent focus:border-[#485A47] focus:bg-white outline-none"
              >
                <option value="">—</option>
            ...
            <div>
              ...
              <select
                ...
                className="w-full text-sm text-gray-700 bg-gray-50 rounded-lg px-3 py-1.5 border border-transparent focus:border-[#485A47] focus:bg-white outline-none capitalize"
              >
                <option value="">—</option>
          ...
          <div className="p-6 border-b border-gray-100">
            ...
            <div className="grid grid-cols-2 gap-3">
              <input
                ...
                className="text-sm text-gray-700 bg-gray-50 rounded-lg px-3 py-2 border border-transparent focus:border-[#485A47] focus:bg-white outline-none"
              />
              <input
                type="date"
          ...
          <div className="p-6 border-b border-gray-100">
            ...
            <div className="flex flex-wrap gap-2 mb-3">
              {(localLead.tags || []).map(tag => (
                <span key={tag} className="flex items-center gap-1 px-3 py-1 rounded-full bg-[#F1F0EB] border border-[#EFE5D4] text-xs text-[#485A47] font-medium">
                  {tag}
            ...
            <div className="flex gap-2">
              <input
                ...
                placeholder="Add tag..."
                className="flex-1 text-sm bg-gray-50 rounded-lg px-3 py-1.5 border border-transparent focus:border-[#485A47] focus:bg-white outline-none"
              />
              <button onClick={addTag} className="px-3 py-1.5 bg-[#485A47] text-white text-xs rounded-lg hover:bg-[#5C715A] transition-colors">Add</button>
            </div>
          </div>
          ...
          <div className="p-6 border-b border-gray-100">
            ...
            <textarea
              ...
              className="w-full text-sm text-gray-700 bg-gray-50 rounded-lg px-3 py-2 border border-transparent focus:border-[#485A47] focus:bg-white outline-none resize-none"
            />
          </div>
          ...
          <div className="p-6 border-b border-gray-100">
            ...
            <textarea
              ...
              className="w-full text-sm text-gray-700 bg-gray-50 rounded-xl px-4 py-3 border border-gray-200 focus:border-[#485A47] focus:bg-white outline-none resize-none mb-2"
            />
            <button
              onClick={addNote}
              disabled={addingNote || !noteText.trim()}
              className="px-5 py-2 bg-[#485A47] text-white text-sm rounded-full hover:bg-[#5C715A] transition-colors disabled:opacity-50"
            >
              ...
              <div className="space-y-4">
                {timeline.map(item => (
                  <div key={item.id} className="flex gap-3">
                    <div className={`mt-1 w-2 h-2 rounded-full shrink-0 ${item.type === "note" ? "bg-[#FE5D5B]" : "bg-[#9AB1C8]"}`} />
                    <div className="flex-1 min-w-0">
